...
This document lists MCP tool names as exposed to MCP clients. XcodeBuildMCP provides 83 canonical tools organized into 16 workflow groups for comprehensive Apple development workflows.
...
**Purpose**: Attach LLDB debugger to simulator and device apps, set breakpoints, inspect variables and call stacks. (9 tools)

- `debug_attach_device` - Attach LLDB to device app.
...
*This documentation is automatically generated by `scripts/update-tools-docs.ts` from the tools manifest. Last updated: 2026-03-10T10:03:41.169Z UTC*
